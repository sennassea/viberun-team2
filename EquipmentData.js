...
var RELIC_DB = [
  { id:"bronze_incense_burner", name:"청동 향로", emoji:"🏺", attr:"범용", rarity:"common", price:70, dropWeight:3, desc:"첫 턴 카드를 1장 추가로 뽑습니다.", fx:[{timing:"battleStart", t:"draw", v:1}] },
  ...
  { id:"moon_spirit_tablet", name:"월령패", emoji:"🌙", attr:"범용", rarity:"common", price:75, dropWeight:3, desc:"전투마다 처음 사용하는 공격 카드의 정화량이 3 증가합니다.", fx:[{timing:"firstAttack", t:"damagePlus", v:3}] },
  ...
  { id:"spirit_thread_doll", name:"혼령매듭 인형", emoji:"🧸", attr:"동요", rarity:"common", price:75, dropWeight:3, desc:"동요를 부여하면 턴당 1회 카드를 1장 뽑습니다.", fx:[{timing:"onAgitationApply", t:"draw", v:1, oncePerTurn:true}] },
