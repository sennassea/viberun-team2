...
const CARD_DB = {
  ...
  folded_ward:{name:"접어둔 방위부", cost:0, type:"defense", emoji:"📄", target:"self", attr:"결계 덱", rarity:"common",
          desc:"결계를 4 얻습니다.", fx:[{t:"block",v:4}]},
  ...
  unsent_words:{name:"전하지 못한 말", cost:2, type:"attack", emoji:"💬", target:"enemy", attr:"회상 덱", rarity:"rare",
          desc:"대상의 현재 회상 수치의 50%만큼 회상을 추가 부여합니다. \n(추가 수치는 최소 1, 최대 2)\n사용 후 소멸.", fx:[{t:"applyRecollectionByCurrentRatio",ratio:0.5,min:1,max:2}], exhaust:true},
  mind_collapse:{name:"마음 붕괴", cost:3, type:"attack", emoji:"🧠", target:"enemy", attr:"회상 덱", rarity:"rare",
          desc:"대상에게 회상 2와 균열 1을 부여합니다. 대상의 회상이 6 이상이면 다른 모든 유령에게 회상 2를 부여합니다.", fx:[{t:"applyRecollection",v:2},{t:"applyFracture",v:1},{t:"ifRecollectionAtLeastApplyRecollectionAll",threshold:6,v:2}]},
  ...
  release_grudge:{name:"한을 풀다", cost:1, type:"skill", emoji:"🧵", target:"self", attr:"한풀이 덱", rarity:"rare",
          desc:"성장한 한풀이 주문 1장을 버림 더미에서 가져옵니다. 이번 턴 비용이 0이 됩니다. 주문 1장을 뽑습니다.\n사용 후 소멸.", fx:[{t:"recoverGrownHanpuri",costZero:true},{t:"draw",v:1}], exhaust:true},
  ...
  warding_dance:{name:"액막이 춤", cost:1, type:"defense", emoji:"💃", target:"self", attr:"굿판 덱", rarity:"common",
          desc:"결계를 4 얻고 방울치기 1장을 손패에 생성합니다.", fx:[{t:"block",v:4},{t:"createCardToHand",key:"bell_strike",v:1}]},
  ...
  heating_ritual:{name:"판이 달아오른다", cost:1, type:"skill", emoji:"🥁", target:"self", attr:"굿판 덱", rarity:"rare",
          desc:"열기 복을 얻습니다. 매 턴 4번째 주문 사용 시 모든 미련을 2 정화합니다. 사용 후 소멸.", fx:[{t:"gainBlessing",key:"heat",v:1}], exhaust:true},
