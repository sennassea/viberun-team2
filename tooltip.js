...
(function () {
  ...
  var TOP_MENU_INFO = [
    ...
    { cls: "ui-depth-button",    name: "심도", desc: "끝없는 여정에서 적용 중인 심도를 확인합니다." },
  ...
  /* ══════════════════════════════════════════════════════════════════════
     IX. 우측 하단 전투 아이콘(턴 종료/뽑을 주문/버린 주문) 툴팁
     ══════════════════════════════════════════════════════════════════════ */

  var DOCK_ICON_INFO = [
    { sel: "#endTurn",     name: "턴 종료",   desc: "현재 턴을 종료하고 적의 행동을 진행합니다." },
    { sel: "#exhaustPile", name: "소멸 주문", desc: "이번 전투에서 소멸되어 다시 뽑을 수 없는 주문을 확인합니다." },
    { sel: "#deckPile",    name: "뽑을 주문", desc: "이번 전투에서 아직 뽑을 수 있는 주문들을 확인합니다." },
    { sel: "#discardPile", name: "버린 주문", desc: "이번 전투에서 사용했거나 버려진 주문들을 확인합니다." }
  ];
