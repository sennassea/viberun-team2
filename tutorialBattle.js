...
(function(){
  ...
  function ensureTutorialBattleIntroStyles(){
    ...
    style.textContent =
      ...
      ".tutorial-battle-intro-dialogue{position:absolute;left:50%;bottom:3cqh;--tutorial-dongjasin-avatar-width:36cqh;--tutorial-dongjasin-avatar-height:64cqh;--tutorial-dongjasin-avatar-left:-35cqh;--tutorial-dongjasin-avatar-top:-41.8cqh;--tutorial-dongjasin-avatar-transform:none;transform:translateX(-50%);z-index:281;width:min(54cqw,72cqh);padding:2.2cqh 2.1cqw;border:0;border-radius:0;background:transparent url(\"assets/ui/dialog_panel.png\") center/100% 100% no-repeat;color:#243247;box-shadow:none;}" +
      ...
      ".tutorial-battle-system-popup{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);z-index:281;width:min(42cqw,62cqh);padding:2.8cqh 2.4cqw;border:0;border-radius:0;background:transparent url(\"assets/ui/dialog_panel.png\") center/100% 100% no-repeat;box-shadow:none;text-align:center;color:var(--c-ink);}" +
