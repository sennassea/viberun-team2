...
const TUTORIAL_DIALOGUE_DATA = [
  ...
  { id: "M-002", part: "여정", section: "현재 위치 안내", condition: "현재 위치 강조", speaker: "동자신", text: "여기가 지금 네 위치야.<br>반짝이는 곳만 잘 봐.", purpose: "현재 위치 설명", target: "현재 위치" },
  { id: "M-003", part: "여정", section: "현재 위치 안내", condition: "M-002 이후", speaker: "동자신", text: "길 잃은 척하면 내가 바로 놀릴 거야?", purpose: "캐릭터 톤 표현", target: "현재 위치" },
  ...
  { id: "M-005", part: "여정", section: "이동 가능 장소 안내", condition: "M-004 이후", speaker: "동자신", text: "선이 이어진 곳으로만 갈 수 있어.<br>아무 데나 훌쩍 가는 건 안 돼.", purpose: "경로 선택 방식 설명", target: "연결선" },
  { id: "M-006", part: "여정", section: "범례 안내", condition: "범례 영역 전체 강조", speaker: "동자신", text: "그래도 앞으로는 갈 곳이 더 많아질 거야.<br>오른쪽에 있는 설명도 봐둬.", purpose: "범례 영역 안내", target: "범례 영역" },
  { id: "M-007", part: "여정", section: "범례 안내", condition: "M-006 이후", speaker: "동자신", text: "기다리는 일이 다르니까,<br>표시를 보고 고르는 게 좋아.", purpose: "장소별 의미 차이 설명", target: "범례 영역" },
  { id: "M-008", part: "여정", section: "기본 위령 범례", condition: "범례의 기본 위령 항목 강조", speaker: "동자신", text: "미련이 느껴지는 곳은 기본적인 위령이 필요한 곳이야.", purpose: "일반 장소 설명", target: "범례: 미련이 느껴지는 곳" },
  ...
  { id: "M-016", part: "여정", section: "선택 완료", condition: "일반 장소 선택 후", speaker: "동자신", text: "좋아, 그쪽으로 가는 거네.<br>그럼 이제 위령을 시작해보자.", purpose: "위령 화면 전환 연결", target: "화면 전환" },
  ...
  { id: "W-008", part: "위령", section: "기본 목표 안내", condition: "위령 UI 표시", speaker: "동자신", text: "주문으로 유령의 미련을 정화해보자.", purpose: "기본 목표 안내", target: "주문 / 유령의 미련" },
  ...
  { id: "W-010", part: "위령", section: "정신력 안내", condition: "W-009 이후", speaker: "동자신", text: "정신력이 다 닳으면 위험해져.<br>그러니까 무작정 버티면 안 돼.", purpose: "패배 조건 안내", target: "정신력 UI" },
  { id: "W-011", part: "위령", section: "정신력 안내", condition: "W-010 이후", speaker: "동자신", text: "아가, 괜히 씩씩한 척하다가 쓰러지면 내가 놀릴 거야?", purpose: "귀엽게 경고", target: "정신력 UI" },
  { id: "W-012", part: "위령", section: "유령 미련 안내", condition: "유령의 미련 UI 강조", speaker: "동자신", text: "저쪽에 보이는 건 유령의 미련이야.", purpose: "적 체력 개념 설명", target: "유령의 미련 UI" },
  ...
  { id: "W-015", part: "위령", section: "신통력 안내", condition: "신통력 UI 강조", speaker: "동자신", text: "주문을 쓰려면 신통력이 필요해.", purpose: "코스트 개념 도입", target: "신통력 UI" },
  ...
  { id: "W-051", part: "위령", section: "마무리 안내", condition: "유령 미련이 적게 남음", speaker: "동자신", text: "남은 미련만 정화하면 돼.", purpose: "마지막 행동 예고", target: "유령의 미련 / 정화 주문" },
