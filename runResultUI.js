"use strict";
/* =========================================================================
   runResult UI 레이어 — runResult.js에서 분리된 화면 렌더링/스타일.
   점수·달빛조각 계산, 스냅샷 생성, 랭킹 제출 같은 로직은 runResult.js에
   남아있고 이 파일은 그 결과를 화면에 그리기만 한다.
...
function ensureRrStyles(){
  ...
  style.textContent =
    ...
    ".rr-lines{text-align:center;color:#4a3524;width:82%;}" +
    ".rr-lines--victory{width:55%;}" +
    ".rr-lines p{margin:0;font-weight:800;word-break:keep-all;}" +
