...
const RELIC_DB = [
  {
    ...
    "trigger": "battleStart",
    "target": "self",
    "desc": "첫 턴 카드를 1장 추가로 뽑습니다.\n은은한 향이 흔들리는 마음을 차분히 가라앉힌다.",
    "effectText": "첫 턴 카드를 1장 추가로 뽑습니다.",
    "valueText": "첫 턴 드로우 +1",
    "dropWeight": 55,
    "price": 120,
    "shopPrice": 120,
  ...
  },
  {
    ...
    "trigger": "firstAttack",
    "target": "self",
    "desc": "전투마다 처음 사용하는 공격 카드의 정화량이 3 증가합니다.\n달빛이 깃든 나무패. 첫 마음가짐을 더욱 또렷하게 만든다.",
    "effectText": "전투마다 처음 사용하는 공격 카드의 정화량이 3 증가합니다.",
    "valueText": "첫 공격 정화 +3",
    "dropWeight": 55,
    "price": 120,
    "shopPrice": 120,
  ...
  },
  {
    ...
    "target": "self",
    "desc": "동요를 부여하면 턴당 1회 카드를 1장 뽑습니다.\n붉은 실로 묶인 작은 인형. 흔들린 마음의 끝을 따라간다.",
    "effectText": "동요를 부여하면 턴당 1회 카드를 1장 뽑습니다.",
...
function getRandomRelic(rng = Math.random){
  const list = Array.isArray(RELIC_DB) ? RELIC_DB : [];
