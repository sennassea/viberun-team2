...
(function () {
  ...
  /* ── 상수 ─────────────────────────────────────────────────────── */
  /* 주문 간격은 .card-hand-area 폭을 기준으로 계산한다. */
  var AREA_PADDING_R  = 0.035;
  /* 주문 폭 fallback: 11.5cqw */
  ...
  function applyLayout() {
    ...
    var cardW  = measuredCardW || (CARD_W_PCT * gameW);          /* 주문 1장 픽셀 폭 */
