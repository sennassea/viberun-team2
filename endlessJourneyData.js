...
const ENDLESS_JOURNEY_DEBUFFS = [
  { id: "endless_depth_1", level: 1, name: "엘리트 출현 증가 I", desc: "엘리트 노드 가중치 x1.35",
    effects: [{ effectType: "eliteNodeWeightMultiplier", value: 0.35 }] },
  { id: "endless_depth_2", level: 2, name: "일반 몬스터 공격 강화", desc: "일반 몬스터 최종 피해 +10%",
    effects: [{ effectType: "normalDamageMultiplier", value: 0.10 }] },
  { id: "endless_depth_3", level: 3, name: "전체 몬스터 성장 I", desc: "최대 체력 x1.07, 최종 피해 x1.04",
  ...
  { id: "endless_depth_6", level: 6, name: "전체 몬스터 성장 II", desc: "최대 체력 x1.07, 최종 피해 x1.04",
    effects: [{ effectType: "enemyHpMultiplier", value: 0.07 }, { effectType: "enemyDamageMultiplier", value: 0.04 }] },
  ...
  { id: "endless_depth_9", level: 9, name: "전체 몬스터 성장 III", desc: "최대 체력 x1.07, 최종 피해 x1.04",
    effects: [{ effectType: "enemyHpMultiplier", value: 0.07 }, { effectType: "enemyDamageMultiplier", value: 0.04 }] },
  { id: "endless_depth_10", level: 10, name: "엘리트 체력 강화", desc: "엘리트 몬스터 최대 체력 +10%",
    effects: [{ effectType: "eliteHpMultiplier", value: 0.10 }] },
  { id: "endless_depth_11", level: 11, name: "보스 공격 강화", desc: "보스 최종 피해 +10%",
  ...
  { id: "endless_depth_15", level: 15, name: "전체 몬스터 성장 V", desc: "최대 체력 x1.07, 최종 피해 x1.04",
    effects: [{ effectType: "enemyHpMultiplier", value: 0.07 }, { effectType: "enemyDamageMultiplier", value: 0.04 }] },
  ...
  { id: "endless_depth_17", level: 17, name: "전체 몬스터 성장 VI", desc: "최대 체력 x1.07, 최종 피해 x1.04",
    effects: [{ effectType: "enemyHpMultiplier", value: 0.07 }, { effectType: "enemyDamageMultiplier", value: 0.04 }] },
